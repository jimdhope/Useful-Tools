...
export function IncidentList({
  ...
  return (
    <aside className="flex w-full shrink-0 flex-col overflow-hidden border-l border-border bg-card md:w-[480px] md:min-w-[480px]">
      <div className="shrink-0 border-b border-border px-4 py-3 space-y-2">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="mr-auto ml-3 rounded border border-border px-2 py-0.5 text-xs text-muted-foreground lg:hidden"
          >
            Show legend
          </button>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 rounded border border-border bg-muted px-3 py-1.5 text-xs text-card-foreground outline-none focus:border-primary"
            autoComplete="off"
          />
          <button
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-border">
        ...
        <button
          ...
          className="rounded border border-border px-2 py-1 text-[0.7rem] text-muted-foreground hover:border-muted-foreground"
        >
          Clear search
        </button>
      </div>
        ...
        {sorted.map((inc) => {
          ...
          return (
            <div
              ...
              className="cursor-pointer rounded-lg border border-border bg-muted p-3 hover:border-primary transition-colors"
            >
