...
export function IncidentList({
  ...
  return (
    <aside className="flex h-full w-full flex-col overflow-hidden border-l border-border bg-card md:w-[420px] md:min-w-[420px]">
      <div className="shrink-0 border-b border-border px-4 py-3 space-y-2">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 rounded border border-border bg-muted px-3 py-1.5 text-xs text-foreground outline-none focus:border-primary"
            autoComplete="off"
          />
          <button
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-border">
        ...
        <button
          ...
          className="rounded border border-border px-2 py-1 text-[0.7rem] text-muted-foreground"
        >
          Clear
        </button>
      </div>
