...
export function MeterReadingGuide() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/smets1-secure-electricity.png" alt="Secure SMETS1 electricity meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/smets1-secure-gas.png" alt="Secure SMETS1 gas meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
          <ol className="list-decimal pl-5 space-y-2">
    ...
    <div className="space-y-6">
      ...
      {variants.map((variant, i) => (
        <Card key={i} className="frosted-glass">
          ...
          <CardContent className="space-y-4">
            <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
              <Image src={variant.image} alt={variant.title} fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
            </div>
            <ol className="list-decimal pl-5 space-y-2">
            ...
            <AccordionItem value={`smets2-${i}`} className="border-0">
              ...
              <AccordionContent className="px-6 pb-6">
                <div className="space-y-4">
                  <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
                    <Image src={meter.image} alt={meter.title} fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
                  </div>
                  <ol className="list-decimal pl-5 space-y-2">
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/electric-single-display.jpg" alt="Digital single electricity meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/electric-dual-display.png" alt="Digital dual electricity meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/electric-dual-single-display.png" alt="Digital dual single display" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/electric-dial-display.png" alt="Electricity dial meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/gas-imperial-display.png" alt="Digital imperial gas meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/gas-metric-display.png" alt="Digital metric gas meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/gas-dial-display.png" alt="Gas dial meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
      ...
      <Card className="frosted-glass">
        ...
        <CardContent className="space-y-4">
          <div className="relative w-full max-w-md mx-auto aspect-video rounded-lg overflow-hidden bg-muted">
            <Image src="/meter-images/generation-meter.jpg" alt="Generation meter" fill sizes="(max-width: 768px) 100vw, 448px" className="object-contain" />
          </div>
