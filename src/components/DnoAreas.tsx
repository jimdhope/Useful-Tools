...
const DNO_AREA_MAP: Record<string, string> = {
  "UK Power Networks": "East England, London, South East England, Southern England",
  "National Grid (Western Power)": "East Midlands, South Wales, West Midlands, South West England",
  "Northern Powergrid": "North East England, Yorkshire",
  "SP Energy Networks": "South and Central Scotland",
  "Electricity North West": "North Wales, Merseyside and Cheshire, North West England",
  "SSEN": "North Scotland",
};
