...
const CENTRES: Record<string, [number, number]> = {
  ...
  WS: [-2.0, 52.5], WV: [-2.5, 52.5], YO: [-1.5, 53.5],
  ZE: [-3.5, 58.5],
};

const ROUGH: Record<string, [number, number]> = {
  A: [-2.0, 57.0], B: [-2.0, 52.5], C: [-3.0, 51.5],
  D: [-2.0, 54.5], E: [-0.1, 51.5], F: [-3.0, 50.5],
  G: [-3.5, 55.0], H: [-0.3, 51.5], K: [-4.0, 55.5],
  L: [-2.5, 53.5], M: [-2.0, 53.5], N: [-0.2, 51.5],
  P: [1.0, 51.0], R: [-1.0, 51.5], S: [-1.5, 53.0],
  T: [-2.5, 52.0], W: [-0.2, 51.5],
};
